...
urlpatterns = [
    ...
    path('formation/recent/', ListRecentFormationView.as_view(), name="recent_formation"),
    ...
    path('lecon/<slug:slug>/', LeconDetailView.as_view(), name="detail_lecon"),
